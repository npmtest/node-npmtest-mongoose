...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mongoose/node_modules/mongoose/lib/promise.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mongoose/node_modules/mongoose/lib/promise.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mongoose/node_modules/mongoose/lib/</a> &#187; promise.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function Promise(fn) {</span>
<span class="cstat-no" title="statement not covered" >  MPromise.call(this, fn);</span>
}
&nbsp;
/**
 ...
 * @api public
 */
Promise.ES6 = <span class="fstat-no" title="function not covered" >function(resolver) {</span>
...
<span class="cstat-no" title="statement not covered" >      promise.complete.apply(promise, arguments);</span>
    },
<span class="fstat-no" title="function not covered" >    function(e) {</span>
<span class="cstat-no" title="statement not covered" >      promise.error(e);</span>
    });
&nbsp;
 ...
 */
&nbsp;
Promise.prototype.catch = <span class="fstat-no" title="function not covered" >function(onReject) {</span>
<span class="cstat-no" title="statement not covered" >  return this.then(null, onReject);</span>
};
&nbsp;
/*!
 ...
 */
&nbsp;
Promise.prototype.error = <span class="fstat-no" title="function not covered" >function(err) {</span>
...
<span class="cstat-no" title="statement not covered" >      err = util.inspect(err);</span>
    }
<span class="cstat-no" title="statement not covered" >    err = new Error(err);</span>
  }
<span class="cstat-no" title="statement not covered" >  return this.reject(err);</span>
};
&nbsp;
/**
 ...
 */
&nbsp;
Promise.prototype.resolve = <span class="fstat-no" title="function not covered" >function(err) {</span>
<span class="cstat-no" title="statement not covered" >  if (err) <span class="cstat-no" title="statement not covered" >return this.error(err);</span></span>
<span class="cstat-no" title="statement not covered" >  return this.fulfill.apply(this, Array.prototype.slice.call(arguments, 1));</span>
};
&nbsp;
/**
